...
var Color = (function () {
  ...
  var Palette = (function () {
    ...
    var Collection = (function () {
      function Collection(idProp) {
        var instance = this;
        instance.idProp = (idProp && "string"==typeof idProp) ? idProp : "id";
        instance.items = {};
      }
      Collection.prototype = {
        ...
        , "add": function (item) {
          var instance = this;
          instance.items[item[instance.idProp]] = item;
          return instance;
        }
        , "get": function (id) {
      ...
      return {
        "create": function (idProp) {
          return new Collection(idProp);
        }
      };
    })();
    return {
